 ...
 * staging Chaoslab GraphQL server.
 */

const DEFAULT_ENDPOINT = "http://localhost:4000/graphql";

const DEFAULT_DOCUMENT = `# Welcome to the Chaoslab GraphQL Playground!
        ...
        {!collapsed && (
          <div className="graphql-config-bar__body">
            <p className="graphql-config-bar__hint">
              Point this to your running Chaoslab GraphQL server. Default:{" "}
