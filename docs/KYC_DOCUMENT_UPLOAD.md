...
```json
{
  ...
  "data": {
    ...
    "file_url": "https://chaoslab-kyc-documents.s3.us-east-1.amazonaws.com/kyc-documents/2024/03/user-id/passport-1234567890-abc123def456.pdf",
    "applicant_id": "abc123",
...
1. **Create S3 Bucket**:
   ...
   - Navigate to S3
   - Click "Create bucket"
   - Enter bucket name (e.g., `chaoslab-kyc-documents`)
