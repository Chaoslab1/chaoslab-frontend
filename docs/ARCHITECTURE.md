...
This backend bridges Chaoslab providers with Stellar via REST/GraphQL APIs backed by PostgreSQL, Redis, and BullMQ for processing.
...
flowchart LR
  ...
  Services --> Mobile[Chaoslab Providers]
