...
This document describes the KYC (Know Your Customer) integration implemented for the Chaoslab application using **Entrust Identity Verification** (formerly Onfido).
