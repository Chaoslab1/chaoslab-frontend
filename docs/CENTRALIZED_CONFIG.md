...
This document describes the centralized configuration management system for the Chaoslab application.
...
CHAOS_ENABLED=false pnpm test tests/services/Chaoslab/chaos.test.ts
...
CHAOS_DROP_CHANCE=0 \
pnpm test tests/services/Chaoslab/chaos.test.ts
