...
merchant     ──(2) nonce ─────────▶ Chaoslab /api/v1/zk/opening-proof
...
- **Verifier lives in the Chaoslab backend, merchant SDKs, and counterparty services** — anywhere off-chain where the receiver can run pure-JS / Rust.
