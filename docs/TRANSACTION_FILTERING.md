...
This feature adds comprehensive transaction status filtering with pagination support to the chaoslab API. Users can now filter transactions by one or multiple statuses and paginate through large result sets efficiently.
