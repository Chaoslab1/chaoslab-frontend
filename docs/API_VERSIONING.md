...
This document describes the API versioning strategy for the Chaoslab application. Versioning allows the API to evolve and introduce breaking changes without affecting existing clients.
