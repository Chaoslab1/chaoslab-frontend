...
This guide covers running the full chaoslab stack locally with a single command.
...
# 2. Fill in your Stellar and chaoslab provider credentials
...
| ---------------------- | -------------------------- | ------ |
| `Chaoslab_postgres` | PostgreSQL 16              | `5432` |
| `Chaoslab_redis`    | Redis 7                    | `6379` |
| `Chaoslab_app`      | Node/Express (live reload) | `3000` |
...
# Open a psql shell
docker compose exec postgres psql -U user -d Chaoslab_stellar
