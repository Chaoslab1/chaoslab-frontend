...
```
DATABASE_URL=postgresql://user:pass@primary:5432/CHAOSLAB
READ_REPLICA_URL=postgresql://user:pass@replica1:5432/CHAOSLAB,postgresql://user:pass@replica2:5432/CHAOSLAB
```
