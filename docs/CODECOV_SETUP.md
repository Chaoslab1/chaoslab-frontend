...
2. Find and select `chaoslab/chaoslab-docs`
3. Copy the upload token shown

### Step 3: Add GitHub Secret

1. Go to https://github.com/chaoslab/chaoslab-docs/settings/secrets/actions
...
```markdown
[![codecov](https://codecov.io/gh/chaoslab/chaoslab-docs/branch/main/graph/badge.svg)](https://codecov.io/gh/chaoslab/chaoslab-docs)
```
...
[![codecov](https://codecov.io/gh/chaoslab/chaoslab-docs/branch/main/graph/badge.svg?style=flat)](https://codecov.io/gh/chaoslab/chaoslab-docs)

<!-- Flat-square style -->

[![codecov](https://codecov.io/gh/chaoslab/chaoslab-docs/branch/main/graph/badge.svg?style=flat-square)](https://codecov.io/gh/chaoslab/chaoslab-docs)

<!-- For-the-badge style -->

[![codecov](https://codecov.io/gh/chaoslab/chaoslab-docs/branch/main/graph/badge.svg?style=for-the-badge)](https://codecov.io/gh/chaoslab/chaoslab-docs)
```
...
```markdown
[![Coverage Status](https://coveralls.io/repos/github/chaoslab/chaoslab-docs/badge.svg?branch=main)](https://coveralls.io/github/chaoslab/chaoslab-docs?branch=main)
```
