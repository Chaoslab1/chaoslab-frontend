...
| ---------- | ---------------------------------- | ---------------------------------- |
| Kotlin/JVM | Maven Central (via Sonatype OSSRH) | `com.Chaoslab:chaoslab-sdk` |
| TypeScript | npm registry                       | `chaoslab-sdk`                 |
...
2. Open a ticket to claim the `com.Chaoslab` namespace.
...
- Verify the package name `chaoslab-sdk` is not already claimed by another user/org on npm.
