...
This document describes the Role-Based Access Control (RBAC) system implemented in the chaoslab backend service. The RBAC system provides fine-grained access control to API endpoints based on user roles and permissions.
...
- **Use Case**: Regular Chaoslab users
